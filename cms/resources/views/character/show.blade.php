...
<body>
    ...
    <div class="content-container">
        ...
        <div class="image-container">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/2.png') }}" alt="Right Image">
        ...
        <div class="image-container">
            <div class="image-wrapper">
                <img src="{{ asset('images/3.png') }}" alt="Left Image">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/4.png') }}"  alt="Right Image">
        ...
        <div class="image-container">
            <div class="image-wrapper">
                <img src="{{ asset('images/5.png') }}" alt="Left Image">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/6.png') }}" alt="Right Image">
        ...
        <!-- 7-8 -->
         <div class="image-container">
            <div class="image-wrapper">
                <img src="{{ asset('images/7.png') }}" alt="Left Image">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/8.png') }}" alt="Right Image">
        ...
        <!-- 9-10 -->
         <div class="image-container">
            <div class="image-wrapper">
                <img src="{{ asset('images/9.png') }}" alt="Left Image">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/10.png') }}" alt="Right Image">
        ...
        <!-- 11-12 -->
         <div class="image-container">
            <div class="image-wrapper">
                <img src="{{ asset('images/11.png') }}" alt="Left Image">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/12.png') }}" alt="Right Image">
        ...
        <!-- 13-14 -->
         <div class="image-container">
            <div class="image-wrapper">
                <img src="{{ asset('images/13.png') }}" alt="Left Image">
            ...
            <div class="image-wrapper">
                <img src="{{ asset('images/14.png') }}" alt="Right Image">
